    ...
    <ul class="navbar-nav">
        ...
        <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
          ...
          <div class="p-1">
            <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
              <div class="me-3">
                <img class="wd-30 ht-30 rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/img/admin/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="admin">
              </div>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <img class="wd-30 ht-30 rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/img/admin/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
        </a>
